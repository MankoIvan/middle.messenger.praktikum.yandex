...
const userTmpl = `
    ...
    <p class="form__title">Профиль</p>
        ...
        <form class="form__container">
            ...
            ${formPiece({name: "second_name", label: "Фамилия", type: "text"})}
            ${formPiece({name: "phone", label: "Телефон", type: "tel"})}
            ${formPiece({name: "chat_name", label: "Имя в чате", type: "text"})}    
        </form>
        <div class="form__buttons">
            <button class="button">Сохранить</button>
            <button class="button__alert">Изменить пароль</button>
            <button class="button__alt">Назад</button>
        </div>
    </div>
`;
export { userTmpl };